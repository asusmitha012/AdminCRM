...
<body>
    <div class="container-fluid" >
        ...
        <div class="col-6" style="text-align:end">
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p><span class="fw-bold">Manager: </span> <?= $result->manager_name ?></p>
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p><span class="fw-bold">Phone: </span> <?= $result->tel ?></p>
            ...
            <a href="javascript:void(0)" onclick="update_client(<?php echo $result->id;?>)"
