            ...
            <div class="small-box bg-info">
              ...
              <!-- <a href="<?php echo base_url(); ?>assets/#" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                ...
                <div class="mt-btn-div">
                    ...
                    type="button" class="btn btn-primary waves-effect waves-light mt-btn">Create Live</a>
                </div>
            </div>
          </div>
          <!-- ./col -->
            <div class="col-lg-3 col-6">
                ...
                <div class="mt-btn-div">
                    <a href="javascript:void(0)" onclick=""
                    type="button" class="btn btn-primary waves-effect waves-light mt-btn">Create Demo</a>
                </div>
                </div>
            </div>
          <!-- ./col -->
