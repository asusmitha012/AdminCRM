<div class="row">
    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap">
        ...
        <tbody>
            <?php foreach($pending_withdraw as $pending){    
            $type =[
                1 => 'Nexus Pay',
                2 => 'Direct'
            ];?>
            <tr>
                ...
                <td><button type="button" class="btn btn-warning btn-xs waves-effect waves-light"
                        onclick="confirm_withdraw(<?php echo $pending->id;?>)">Process</button>
                    <button type="button" class="btn btn-info btn-xs waves-effect waves-light"
                        onclick="reject_withdraw(<?php echo $pending->id;?>)">Reject</button>
                </td>
            </tr>
            <?php }?>
        </tbody>
