                            ...
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <img class="img-responsive"
                                            src="<?php echo base_url(); ?>assets/logo/logo-b.png" alt="logo"
                                            style="width:250px;" />
                                ...
                                <tr>
                                    ...
                                    <td class="content-block">
                                        ...
                                        Please use this credentials for your account <br />


                                        <br /><br />Username - <?php echo $email;?><br />
                                        Password - <?php echo $password;?> <br />

                                        <br /><br />
                                        
                                        Please Feel Free to Revert to me on this email ID "" If
                                        Any
                                        Clarification
                                        on<br />
                                        the Account. Also, <br />if You Are
                                        Agreed with the Terms and Conditions and Kindly Share the Documents with us
                                        to Proceed<br />
                                        ...
                                        <br />
                                        CRM LINK - <a
                                            href="<?php echo base_url(); ?>login"><?php echo base_url(); ?>login</a>;
                                    </td>
